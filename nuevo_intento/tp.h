...
class InterpreteBF {
    ...
    */
    InterpreteBF(string etda, string slda,vector<char> *script);
...
class PrioriColaInterpProtegida{
    ...
    mutex centinela; 
    bool seEncolo; 
    condition_variable seEncolo_variable; 
    ...
    */
    PrioriColaInterpProtegida(bool &colaAbierta);
...
class HiloBF: public Thread {
    ...
    */
    HiloBF(PrioriColaInterpProtegida &hCola) ;
...
class ThreadPool{
    ...
    ThreadPool(size_t cantidadHilos);
    ...
    /*Procesa una linea recibida de la entrada estandar del ThreadPool
      ...
      reservada.
    */
    InterpPriori *procesar_linea(string &linea);
...
class Interpretador{
    ...
    */
    Interpretador(string &rutaScript);
